...
def object_with_fields(object, fields=None, deep_fks=None):
    """
...
def object_detail(
    object, m2m_fields=None, related_only=None, related_exclude=None, deep_fks=None
):
    """
    ...
    if related_exclude is None:
        related_exclude = []
    result = object_with_fields(object, deep_fks=deep_fks) + "\n"
    # m2m fields:
